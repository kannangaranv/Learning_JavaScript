...
let user = "Nimal's Account";
user = "Nuwan"
console.log(user);

// two variables cannot declare with the same name
// let user = "Nuwan"; // error
...
// data types
let name = "Nuwan"; //string
let age = 25; // number

let num1 = 23355363645775
console.log(num1*25);
